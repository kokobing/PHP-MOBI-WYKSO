                ...
                <div class="panel widget">
                  ...
                  <div class="panel-body">
                    ...
                    <div class="content-grid column-xs-1 column-sm-4 column-md-5 column-lg-6  height-xs-3">
                      ...
                      <?php 
						//抽取编辑区块名称
						$strSQL="SELECT * FROM layoutpic WHERE  id_layout='$_GET[editlist]' ";//需要编辑的区块
					  ...
					  ?>
                        <li> <a href="#">
                          <div class="menu-icon"><img src="/upload/layout/<?=$Layoutinfopics[$i][opicname]?>" alt="<?=$Layoutinfopics[$i][title]?>"></div>
                          </a>
                          <div class="menu-text"><?=$Layoutinfopics[$i][title]?>
                            <div class="menu-info">
...
$.post('../ajax_php/site/ajax_getlayoutpicinfo.php',{picid:picid},function(data) {
  ...
  (new PNotify({
    ...
    history: {
	 ...
	 $.post('../ajax_php/site/ajax_editlayoutpicinfo.php',{picid:picid,pictitle:$('#pictitle').val(),picintro:CKEDITOR.instances.picintro.getData()},function() {
