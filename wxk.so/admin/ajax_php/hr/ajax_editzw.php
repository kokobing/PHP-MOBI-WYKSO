...
$c_url='/hr/hrzw.html';//当前AJAX文件的 父级文件 对应出当前AJAX文件的权限  注意：菜单的URL文件名更换 一旦生成之后 保持固定 不要随意更换 更换后 相应修改此处
...
if( isset($_SESSION[username])){// 只有登陆用户才可以添加 
 ...
 if($ajaxispermit[ED]=='1'){

   //部门名称入库
   $strSQL="UPDATE hr_zw SET zwname='".$_POST["newzwname"]."' where  zwname='".$_POST["oldzwname"]."' ";
