...
ajax_editlayoutpicinfo.php   图片标题 简介 入库
...
if( isset($_SESSION[username]) && $ajaxispermit[ED]){// 只有登陆用户才可以删除 
	...
	$strSQL="UPDATE layoutpic SET title='".$_POST[pictitle]."',intro='".$_POST[picintro]."',url='".$_POST[picurl]."' where  id_layoutpic='".$_POST[picid]."' ";
