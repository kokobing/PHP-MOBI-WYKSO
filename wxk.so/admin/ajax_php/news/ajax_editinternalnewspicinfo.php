...
ajax_editinternalnewspicinfo.php   图片标题 简介 入库
...
if( isset($_SESSION[username]) && $ajaxispermit[ED]){// 只有登陆用户才可以删除 
	...
	$strSQL="UPDATE newspic SET title='".$_POST[pictitle]."',intro='".$_POST[picintro]."',id_hr='".$_SESSION[userid]."' where  id_newspic='".$_POST[picid]."' ";
