...
//取出他关注的用户ID
$strSQL = "select gzid from guanzhu  where id_member='$_GET[fun]' " ;
$objDB->Execute($strSQL);
$allgz=$objDB->GetRows();
...
<div data-role="navbar">
    <ul>
        <li><a href="#"  class="ui-btn-active"><i class="fa fa-comment"></i> 他的关注</a></li>
        <li><a href="whowatch.html?fun=<?=$_GET[fun];?>"><i class="fa fa-users"></i> 谁在关注</a></li>
    </ul>
</div><!-- /navbar -->
