...
<div data-role="navbar"  id="topmenu">
    <ul>
        <li><a href="#" class="ui-btn-active">作品</a></li>
...
<div class="innerleftimg"><a href="/artsinfo-<?=$allNewsInfo[$i][id_member]?>.html"><img src="/upload/pics/<?=$allNewsInfo[$i][photo]?>" width="40" height="40" /></a>

<? if($allNewsInfo[$i][level]=='2' && $allNewsInfo[$i][status]=='1'){?>
<div class="c_level">艺术家</div>
<? }elseif($allNewsInfo[$i][level]=='3' && $allNewsInfo[$i][status]=='1'){?>
<div class="c_level">机构</div>
<? }else{?>
<div class="c_level">个人</div>
<? }?>
