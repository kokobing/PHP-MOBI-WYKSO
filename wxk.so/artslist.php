...
$strSQL = "select id_member,memid,name,intro,photo from member  where status='1' and level='2' order by id_member desc limit 0,5" ;
...
<div data-role="navbar"  id="topmenu">
    <ul>
        ...
        <li><a href="#" class="ui-btn-active">艺术家</a></li>
